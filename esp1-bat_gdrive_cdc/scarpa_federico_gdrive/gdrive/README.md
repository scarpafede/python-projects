...
#consegna #programma #idle #vscode #python #esercizi #esempi #struttura #informatica #funzioni #def #import #time #sys #os #open #read #percorso #log #file #readlines #for #platform #path #crossplatform #gdrive #cdc #bat #creazione
