...
Il programma hosts2.py visualizza il contenuto del file hosts presente nella cartella flussi, printando però solamente le righe, contenute in esso, che non presentano un cancelletto all'inizio.
...
#consegna #programma #idle #vscode #python #esercizi #esempi #struttura #informatica #funzioni #def #import #time #sys #os #open #read #percorso #log #file #readlines #for #filtro #hosts #platform #path #crossplatform
