...
def main():
    '''
    Esegue il programma principale, chiede all'utente quale esercizio eseguire e lo esegue
    '''
    # variabili utilizzate per i controlli dell'input
    check_esercizio = 0
    check_numeri = 0
    check_input = 0
    ...
    if esercizio == 1:
        ...
        print("L'MCD tra i due numeri inseriti e'", MCD)
    ...
    # secondo esercizio
        ...
        while check_input == 0:
            try:
                ...
                print("Riprovare. Si prega di inserire numeri o qualcosa")
        print("Pigreco:", pigreco(cont_volte))


def mcd(primoN, secondoN):
    '''
    Restituisce il MCD tra primoN e secondoN
    '''
...
def pigreco(cont_volte):
    '''
    Esegue e printa a schermo il pigreco calcolato un numero di volte fornito da input
    '''
    divisore = 1
    risultato =  0
    cont = 1
