...
Descrizione: 1. data una stringa, il programma restituisce la prima posizione che compare un carattere dato in essa,
                2. date due stringhe, le confronta e restituisce la prma volta che compare un carattere in comune tra di esse.
"""
...
def main():
    ...
    """
    controllo_inp_esercizio = 1
    while controllo_inp_esercizio == 1:
        try:
            print("L'esercizio 1 restituisce la prima posizione di un carattere in una stringa")
            print("L'esercizio 2 e' simile al primo, ma utilizza due stringhe")
            esercizio = int(input("Quale esercizio vuole eseguire? 1 o 2? "))
            while esercizio != 1 and esercizio != 2:
                esercizio = int(input("Vuole eseguire il numero 1 o 2? "))
            controllo_inp_esercizio = 0
        except:
            print("Riprovare")
