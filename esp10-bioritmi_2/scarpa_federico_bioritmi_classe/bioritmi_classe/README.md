...
Fornendo un uno, i bioritmi verranno calcolati considerando solamente il giorno inserito, mentre fornendo un numero maggiore, è possibile trovarli automaticamente per ogni giorno successivo a tale data.
...
Un esempio di esecuzione da terminale Windows:
...
#esercizi #informatica #python #programma #deploy #command_line #csv #bioritmi #classe #data #giornisuccessivi
